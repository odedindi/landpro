...
def predict_main(aoi_json:dict)->dict:
    ...
    prediction = split_polygon(aoi_json)
...
if __name__ == '__main__':
    ...
    complete_json = predict_main(aoi_json)
